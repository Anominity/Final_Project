...
growth <- prop_data %>% 
  ...
  pivot_longer(cols = starts_with("growth"), names_to = "period", values_to = "gdp_perc_growth", names_prefix = "growth_perc_") %>% 
...
model_w_kfold <- train(gdp ~ 1 + total_population_in_thous + p_employed + p_agr_for_fish +                                                                 
    p_ind_inc_energy + p_ind_manuf + p_const + 
    prop_dist_trd_reprs_transp_accom_food_serv_activ + p_inf_com + 
    p_fin_insur + p_real_estate + p_prof_sci_techn_act_adm_supp + 
    p_pub_adm_compul_ss_ed_hhealth + p_other + 
